...
if ( !function_exists( 'bogocomm_get_site_path' ) ) {
...
if ( !function_exists( 'bogocomm_localize_current_url' ) ) {
...
if ( !function_exists( 'bogocomm_unparse_url' ) ) {
...
if ( !function_exists( 'bogocomm_move_lang_slug_from_path_to_query_string' ) ) {
	function bogocomm_move_lang_slug_from_path_to_query_string( $request_uri ) {
		return preg_replace( '@^('.bogocomm_get_site_path().')'.bogo_get_lang_regex().'/(.*)$@', '$1$3?lang=$2', $request_uri );
	}
}

if ( !function_exists( 'bogocomm_update_rewrite_rule_query_string' ) ) {
...
if ( !function_exists( 'bogocomm_starts_with' ) ) {
